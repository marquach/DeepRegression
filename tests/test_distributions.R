...
model_poisson_torch %>% fit(epochs = 300, validation_split = 0.2)
...
model_gamma_tf <- deepregression(y = y,
                                    ...
                                    engine = "tf",
                                    orthog_options = orthog_options)
model_gamma_tf %>% fit(epochs = 300, validation_split = 0.2)
...
model_gamma_torch <- deepregression(y = y,
                                      ...
                                      subnetwork_builder = subnetwork_init_torch,
                                      model_builder = torch_dr)
model_gamma_torch %>% fit(epochs = 300, validation_split = 0.2)
